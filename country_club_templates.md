...
Interested in a quick chat on how this might work for [company_short_name]? We’d love to share how Swoop can elevate your golfers’ experience.
...
```
## docs\templates\country_club\fb_manager_initial_outreach_2.md
```markdown
Hey [firstname],
...
```
## docs\templates\country_club\golf_ops_initial_outreach_1.md
```markdown
Hi [firstname],
