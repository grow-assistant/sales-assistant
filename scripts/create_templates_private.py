...
def main():
    # Define the email templates for private clubs, preserving references to
    # "Pinetree Country Club" and the original copy points from the user’s
    # country club templates. We’ll keep “country club” references where they
    # appear in the success story, since Pinetree is explicitly mentioned.
...
"""
    ...
    # Create the output directory for private clubs
    output_dir = "docs/templates/private_club"
